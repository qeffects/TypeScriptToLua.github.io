...
var monaco_editor_core = __webpack_require__(195);
...
var languageFeatures_LibFiles = /** @class */ (function () {
    ...
    LibFiles.prototype.getOrCreateModel = function (uri) {
        ...
        if (this.isLibFile(uri) && this._hasFetchedLibFiles) {
            return monaco_editor_core["f" /* editor */].createModel(this._libFiles[uri.path.slice(1)], 'javascript', uri);
        }
        return null;
    };
...
var languageFeatures_DiagnosticsAdapter = /** @class */ (function (_super) {
    ...
    function DiagnosticsAdapter(_libFiles, _defaults, _selector, worker) {
        ...
        _this._disposables.push(monaco_editor_core["f" /* editor */].onDidCreateModel(onModelAdd));
        ...
        monaco_editor_core["f" /* editor */].getModels().forEach(onModelAdd);
        return _this;
    }
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        for (_i = 0, renameLocations_1 = renameLocations; _i < renameLocations_1.length; _i++) {
                            ...
                            edits.push({
                                resource: monaco_editor_core["e" /* Uri */].parse(renameLocation.fileName),
                                edit: {
...
function setupMode(defaults, modeId) {
    ...
    monaco_editor_core["g" /* languages */].registerSignatureHelpProvider(modeId, new SignatureHelpAdapter(worker));
