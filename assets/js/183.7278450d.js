...
var monaco_contribution = __webpack_require__(48828);
                    ...
                    case 3:
                        ...
                        for (_i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
                            ...
                            if (refModel) {
                                ...
                                matchedLibFile = monaco_contribution/* typescriptDefaults.getExtraLibs */.TG.getExtraLibs()[entry.fileName];
                                if (matchedLibFile) {
                                    libModel = monaco_editor_core/* editor.createModel */.j6.createModel(matchedLibFile.content, 'typescript', uri);
                                    return [2 /*return*/, {
                                            uri: uri,
